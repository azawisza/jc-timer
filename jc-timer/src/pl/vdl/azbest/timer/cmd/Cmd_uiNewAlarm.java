...
public class Cmd_uiNewAlarm implements Command {

	public Cmd_uiNewAlarm(AlarmData adata) {
		this.aData=adata;

	}

	private AlarmData aData = null;

	public void execute() {
		AlarmClock.getInstance().scheduleAlarm(aData);
