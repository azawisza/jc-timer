...
import pl.vdl.azbest.timer.gui.Shell_RestartButton;

public class Cmd_uiStop implements Command {
	public void execute() {
		if (Conf.getInstance().isRButtonOpened())
			Shell_RestartButton.getInstance().resetCounter();
